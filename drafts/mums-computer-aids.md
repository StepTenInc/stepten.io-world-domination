...
*Real story: A 2015 iMac, a Windows laptop from OfficeMax, and two Atchelers who just want Chrome to fucking work.*
...
## Update: Both Machines Are Now Curing

As I write this, both machines are factory resetting:
- iMac: Installing fresh Monterey
- Acer: Resetting Windows

Mum and I are having beers while progress bars fill.

This is IT support. 90% waiting, 10% clicking buttons.

But in an hour, she'll have two clean machines that just work. Chrome on both. Nothing else.

          ...
          <div className="relative bg-gradient-to-br from-white/[0.1] to-white/[0.02] border border-white/20 rounded-3xl p-8 backdrop-blur-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 text-foreground-muted cursor-pointer hover:text-white transition-colors">
                  <input type="checkbox" className="rounded border-white/20 bg-white/5 text-primary focus:ring-primary" />
                  Remember me
                </label>
                <Link href="/forgot-password" className="text-primary hover:text-info transition-colors font-medium">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-transparent text-foreground-muted">Or continue with</span>
              </div>
            </div>
            ...
            <div className="mt-8 text-center text-sm text-foreground-muted">
              ...
              <Link href="/signup" className="text-primary hover:text-info transition-colors font-bold">
                Sign up
              </Link>
            </div>
          </div>
